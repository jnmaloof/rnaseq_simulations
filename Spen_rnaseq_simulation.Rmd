...
```{r create runStar}
RunStar <- function(fasta, prefix, param.file = "../STAR.params.1", args = "", dir =".", twopassMode = "Basic", n=12) {
  old.dir <- getwd()
  setwd(dir)
  system(paste("STAR", 
               "--parametersFiles", param.file,
               "--readFilesIn", fasta,
               ifelse(grepl("\\.gz$",fasta),"--readFilesCommand zcat",""),
...
### Run it!
```{r, eval=FALSE}
RunStar(fasta="sample_01_renamed.fasta.gz",prefix = "STAR_1",dir="spen_sim_1")
RunStar(fasta="sample_01_renamed.fasta.gz",prefix = "STAR_1",dir="slyc_sim_1")
```
