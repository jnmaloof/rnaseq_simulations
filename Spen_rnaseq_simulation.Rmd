...
Investigate...
Lets take a look at the bam file and extract reads from a few genes with 0 mapped reads.  Skip chromosome 1
```{r}
head(count_comparison[count_comparison$chrom=="01" & count_comparison$count.mapped==0,],n=20)
library(Rsamtools)
reads <- scanBam(file="spen_sim_1/STAR_1Aligned.sortedByCoord.out.bam")[[1]]
