...
cat > STAR.params.1
runThreadN 2
genomeDir ~/Sequences/ref_genomes/tomato/ITAG2.4_Chromo2.5/STAR_genome
twopassMode Basic
...
```{r eval=FALSE, engine='bash'}
    cd spen_sim_1
    STAR --parametersFiles ../STAR.params.1 --readFilesIn ./sample_01.fasta --outFileNamePrefix STAR_1 
```
...
### Correlation
```{r}
known.counts <- read.delim("spen_sim_1/sim_tx_info.txt")
head(known.counts)
```
