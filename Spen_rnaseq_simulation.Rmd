...
CompareCounts <- function(known.counts,mapped.counts, title= NULL, plot = TRUE, chrom.separate = TRUE, correlation=TRUE, return.merged.table=TRUE) {
  ...
  if(return.merged.table) return(count.comparison)
}
```
...
```{r compare_spen1}
CompareCounts(pen.known.counts, pen.mapped.counts, title = "S. pen.  STAR mapped.  Default parameters")
CompareCounts(lyc.known.counts, lyc.mapped.counts, title = "S. lyc.  STAR mapped.  Default parameters")
```
