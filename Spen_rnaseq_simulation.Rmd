...
```{r eval=FALSE, engine='bash'}
cd spen_sim_1
STAR --parametersFiles ../STAR.params.3 --readFilesIn ./sample_01_renamed.fasta --outFileNamePrefix STAR_2 
samtools index STAR_2Aligned.sortedByCoord.out.bam
```

### Load in mapped counts
```{r }
mapped_counts.3 <- read.delim("spen_sim_1/STAR_2ReadsPerGene.out.tab",header = FALSE, stringsAsFactors = FALSE)
