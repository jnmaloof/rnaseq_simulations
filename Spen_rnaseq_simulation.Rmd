...
pen.transcripts
#for lyc transcripts, just trim the names
...
lyc.transcripts.small <- lyc.transcripts[names(lyc.transcripts) %in% orthologs$LYC]
...
system.time(
  simulate_experiment(fasta="~/Sequences/ref_genomes/tomato/ITAG2.4_Chromo2.5/ITAG2.4_cds.pen.orthologs.only.fasta",
                      ...
                      error_model="illumina5",
                      bias="rnaf",
                      transcriptid=orthologs$PEN.LYC[match(names(lyc.transcripts.small),orthologs$LYC)]
  )
)
