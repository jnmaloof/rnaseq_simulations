...
```{r Functions_GetMappedCounts}
GetMappedCounts <- function(prefix, dir=".", type="STAR") {
...
```{r }
pen_mapped_counts <- GetMappedCounts(prefix = "STAR_1", dir = "spen_sim_1")
lyc_mapped_counts <- GetMappedCounts(prefix = "STAR_1", dir = "slyc_sim_1")
```
