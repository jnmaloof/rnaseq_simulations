...
```{r get_mapped_counts }
#using featureCounts from Rsubread
pen.mapped.counts.to3prime <- GetMappedCounts(prefix = "STAR_1_map_2_3prime",
                                     dir = "spen_threeprime_sim_1",
                                     type="transcript",
                                    gff="~/Sequences/ref_genomes/tomato/ITAG2.4_Chromo2.5/ITAG2.4_three_prime_250_250.gff3")

lyc.mapped.counts.to3prime <- GetMappedCounts(prefix = "STAR_1_map_2_3prime",
                                     dir = "slyc_threeprime_sim_1",
                                     type="transcript",
                                     gff="~/Sequences/ref_genomes/tomato/ITAG2.4_Chromo2.5/ITAG2.4_three_prime_250_250.gff3")
```
...
pen.count.comparison.1.to3prime <- CompareCounts(pen.known.counts, pen.mapped.counts.to3prime, title = "S. pen. STAR mapped to 3prime.  Default parameters.  FeatureCounts counting")
```
## Comparison (_S. lyc_)
```{r compare_slyc1_3DGE}
lyc.count.comparison.1.to3prime <- CompareCounts(lyc.known.counts, lyc.mapped.counts.to3prime, title = "S. lyc. STAR mapped to 3prime.  Default parameters FeatureCounts counting")
```
