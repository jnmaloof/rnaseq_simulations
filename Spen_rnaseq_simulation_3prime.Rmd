...
## find overlaps
```{r, eval=TRUE}
lyc.transcript.gr <- import("~/Sequences/ref_genomes/tomato/ITAG2.4_Chromo2.5/ITAG2.4_three_prime_250_250.gff3",feature.type="mRNA")
...
pen.transcript.gr <- PSL2Granges(file="pen_3prime_to_lycGENME.psl")
