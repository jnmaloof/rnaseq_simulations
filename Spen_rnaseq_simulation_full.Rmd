...
system.time(align("Slyc_Chromo2.5_subread_index","spen_sim_2/sample_01_renamed.fastq.gz", nthreads = 2))
```
...
pen.mapped.counts <- GetMappedCounts(dir="spen_sim_2/",type = "featureCounts",bam = "sample_01_renamed.fastq.gz.subread.BAM")
```
