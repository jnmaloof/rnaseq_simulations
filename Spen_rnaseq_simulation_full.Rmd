...
system.time(RunBowtie2(fastq = "spen_sim_2/sample_01_renamed.fastq.gz",
...
## Map
```{r,eval=FALSE}
system.time(RunStampy("spen_sim_2/sample_01_renamed.fasta.gz",index = "SL2.5",dir = "spen_sim_2", threads=2))
```
