...
RunKallisto(fasta = "spen_sim_1/sample_01_renamed.fastq.gz", index = "ITAG2.4._cds.pen.orthlogsonly.kai", dir = "spen_sim_1/kallisto" )
```
...
RunKallisto(fasta = "spen_sim_1/sample_01_renamed.fastq.gz", index = "ITAG2.4._cds.pen.orthlogsonly.21.kai", dir = "spen_sim_1/kallisto21" )
```

## Load in mapped counts
```{r get_mapped_counts_kallisto21 }
pen.mapped.counts <- GetMappedCounts(dir = "spen_sim_1/kallisto21", type="kallisto-transcripts")
```
